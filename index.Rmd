...
```{r, eval = TRUE, echo = FALSE, fig.align = "center", dpi = 300, out.width = "60%", fig.asp = .8}
...
```{r, message = FALSE, fig.align = 'center', echo = FALSE, message = FALSE, results = "hide",dpi = 300, out.width = "60%", fig.asp = .8}
...
```{r, fig.align = 'center', echo = FALSE, dpi = 300, out.width = "800px", fig.asp = .58}
plot(heart.fff)
```
